...
contract StarNotary is ERC721, ERC721Metadata {
    ...
    constructor () ERC721Metadata("Tiny Little Star", "TLS") public {
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You are not the owner of either stars");
